...
DEFAULT_MODELS = {
    ...
    "fixed_prototype_triplets": HUMAN_V1_OUTPUT_DIR,
    "fixed_prototype_control": HUMAN_V1_SHUFFLED_OUTPUT_DIR,
    "batch_prototype_triplets": HUMAN_V2_OUTPUT_DIR,
    "high_pressure_triplets": HUMAN_V3_OUTPUT_DIR,
}
